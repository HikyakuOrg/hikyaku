        ...
        <div className="max-w-7xl mx-auto py-8 px-4 space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="icon" onClick={() => router.push('/dashboard/fleet/vehicles')}>
                ...
                <div className="flex items-center gap-2">
                    <Button variant="outline" onClick={() => router.push(`/dashboard/fleet/vehicles/${id}/edit`)}>
                        ...
                        {currentDriver ? (
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4 text-sm">
                                    ...
                                    <Button variant="secondary" className="w-full" onClick={() => router.push(`/dashboard/fleet/drivers/${currentDriver.id}`)}>
                                        View Driver Profile
